...
from server.ml.features import build_features, FEATURE_COLS
from server.ml.features_v2 import FEATURE_COLS_V2_MARKET
...
def build_features_filtered(symbol: str, exclude_neutral: bool = True) -> pd.DataFrame:
    ...
    from server.ml.features import _load_ohlc
    ...
    # Market sentiment
    from server.ml.features_v2 import _load_market_sentiment
...
def run_lstm_backtest(symbol: str, target_col: str = "target_t3",
    ...
    if exclude_neutral:
        ...
        from server.ml.features_v2 import build_features_v2
